...
#'   \item{abono_mensual_tarifa}{Only Arganda dwellers. Only for travelers who have a car available as a driver. Willingness to pay a flat monthly fee, that would you allow to use the R3 as many times as you like. In €. Note: ERROR: 6 respondents from Arganda report an amount of money without having car available as a driver}
...
#'   \item{carpooling}{Only Arganda dwellers. Only for travelers who have a car available as a driver. Willingness to share the vehicle with an unknown third person if that allows the driver to enjoy a discount to use the R3 toll highway}
#'   \item{carpooling_descuento}{Only Arganda dwellers. Only for travelers who have a car available as a driver. On a trip with similar characteristics to the one you made, from which toll discount would you choose the R3. In €}
#'   \item{carpooling_descuento_2}{Created from carpooling and carpooling_descuento. If carpooling=NO, carpooling_descuento_2=0. Only Arganda dwellers. Only for travelers who have a car available as a driver. On a trip with similar characteristics to the one you made, from which toll discount would you choose the R3. In €}
...
#'   \item{ArgRiv_Cluster_Income}{Average household income of all census sections}
