...
Del dataset Output_Cluster hay que revisar muchas de las columnas de las porpiedades por que son iguales
```{r}
...
Si cogio el bus, le preguntan tambi?n.
En cambio: para el metro solo le preguntan a los que han cogido otro mode diferente al metro.
sumar P30 y P33 y quitar la gente que ya coge el metro.En el Excel de Juan ya est?n sumados en las variables: elegiria_bus_express y elegiria_metro. NO ENTIENDO ESTO AHORA.
...
```
Estratificamos la variable conocimiento. Hay que tener cuidado que de esta manera le hemos puesto 0 tambien a Rivas. Ademas del intervalo -0.5 a 0.5.
